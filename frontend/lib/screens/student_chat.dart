...
class _StudentChatScreenState extends State<StudentChatScreen> {
  ...
  Future<void> _sendMessage() async {
    ...
    final studentName = 'Student'; // Fixed sender name
      ...
      appBar: AppBar(
        title: Column(
          ...
          children: [
            ...
            Text(
              'Chat with ${widget.supervisorName}',
              style: Theme.of(
                context,
  ...
  Widget _buildMessageBubble(ChatMessage message) {
    final isStudentMessage = message.senderType == 'STUDENT';
        ...
        children: [
          ...
          Padding(
            padding: EdgeInsets.only(
              left: isStudentMessage ? 0 : 12,
              right: isStudentMessage ? 12 : 0,
              bottom: 4,
            ),
            child: Text(
              message.senderName,
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: isStudentMessage ? Colors.blue[400] : Colors.grey[200],
              borderRadius: BorderRadius.only(
                topLeft: const Radius.circular(16),
                topRight: const Radius.circular(16),
                bottomLeft: Radius.circular(isStudentMessage ? 16 : 4),
                bottomRight: Radius.circular(isStudentMessage ? 4 : 16),
              ),
            ),
            ...
            child: Text(
              ...
              style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                color: isStudentMessage ? Colors.white : Colors.black87,
              ),
            ),
          ),
